document.addEventListener('DOMContentLoaded', function () {
    ...
    submitButton.addEventListener('click', function(e) {
        ...
        if (validatedCustomerData && !submitButton.disabled) {
            ...
            setTimeout(() => {
                alert('Demo: This would normally redirect you to a secure third-party verification service to complete your direct debit setup. The form would then be processed and you would receive confirmation via email.');
    ...
    function createDemoValidator() {
        ...
        return function () {
            ...
            timeoutID = setTimeout(() => {
                ...
                const isValidCustomer = /^2000\\d{7}$/.test(customerNumber);
                ...
                if (!customerNumber || !postcode || postcode.length < 5 || postcode.length > 7 || !isValidCustomer) {
                    ...
                    if (!isValidCustomer && customerNumber) {
                        ...
                        errorMsg.textContent = 'Demo: Customer number must start with 2000 and be 11 digits long. Try: 20001234567';
